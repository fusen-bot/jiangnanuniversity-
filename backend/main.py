...
# 添加文件上传配置
UPLOAD_FOLDER = '/Users/changfusheng/Desktop/学报/PY_AUTO/uploads'
...
def extract_authors():
    ...
    if file and allowed_file(file.filename):
        ...
        try:
            # 提取作者信息
            papers_info = extract_author_info(filepath)
            
            if papers_info:
                # 生成Excel报告
                output_path = os.path.join(OUTPUT_PATH, f'{filename}_统计结果.xlsx')
